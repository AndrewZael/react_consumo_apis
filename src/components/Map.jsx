...
const Map = ({ userLocation, markets, centerMap }) => {
    ...
    loader.load().then(() => {
        ...
        if(MAP === null && userLocation !== undefined){
            ...
            directionRender = new window.google.maps.DirectionsRenderer({ polylineOptions: { strokeColor: COLOR } });
            MAP.setCenter(userLocation !== undefined ? options.center : optionsDefault.center);
            MAP.setZoom(userLocation !== undefined ? options.zoom : optionsDefault.zoom);
        }
